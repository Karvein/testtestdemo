...
public class ThreadPoolsTest {
    ...
    public void cachedTest(){
        ExecutorService executorServiceCached = Executors.newCachedThreadPool(new testThreadPoolFactory("CachedThreadPool"));
        for (int i = 0; i < 10; i++) {
    ...
    public void fixedTest(){
        ExecutorService executorServiceFixed = Executors.newFixedThreadPool(5, new testThreadPoolFactory("fixedThreadPool"));
        for (int i = 0; i < 10; i++) {
            executorServiceFixed.submit(() -> {
